...
public class PayrollTest {
    @Test
    public void payCheckMaker_shouldCalculatePay_whenFullTime()
    {
    ...
    @Test
    public void payCheckMaker_shouldCalculatePay_whenPartTime()
    {
    ...
    @Test
    public void payCheckMaker_shouldCalculatePay_whenPartTimeWithOvertime()
    {
    ...
    @Test
    public void payCheckMaker_shouldCalculatePay_whenContract()
    {
    ...
    @Test
    public void payCheckMaker_shouldCalculatePay_whenSeasonal()
    {
    ...
    @Test
    public void payCheckMaker_shouldCalculatePay_whenSeasonalWithOvertime()
    {
